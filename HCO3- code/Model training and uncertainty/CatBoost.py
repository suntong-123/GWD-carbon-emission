...
plt.title(f"CatBoost Regression (Normalized): True vs Predicted")
plt.grid(True)

plt.tight_layout()
plt.savefig(
    r"C:\Users\doomsday\Desktop\干活\2025.4.12\catboost\CatBoost Regression (Normalized) True vs Predicted.png",
    format='png',
    dpi=300,
    bbox_inches='tight'
)
...
# 保存图像并显示
plt.savefig(
    r"C:\Users\doomsday\Desktop\干活\2025.4.12\catboost\catboost_kde_plot_1.png",  # 根据路径修改
    format='png',
    dpi=300,
    bbox_inches='tight'
)
...
# 保存图像并显示
plt.savefig(
    r"C:\Users\doomsday\Desktop\干活\2025.4.12\catboost\catboost_kde_plot_2.png",  # 根据路径修改
    format='png',
    dpi=300,
    bbox_inches='tight'
)
...
# 保存图像并显示
plt.savefig(
    r"C:\Users\doomsday\Desktop\干活\2025.4.12\catboost\catboost_kde_plot_3.png",  # 根据路径修改
    format='png',
    dpi=300,
    bbox_inches='tight'
)
